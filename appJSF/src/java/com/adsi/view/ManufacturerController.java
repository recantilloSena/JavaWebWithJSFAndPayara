...
import com.adsi.modelo.Manufacturer;
import com.adsi.view.util.JsfUtil;
import com.adsi.view.util.JsfUtil.PersistAction;
import com.adsi.controller.ManufacturerFacade;
...
public class ManufacturerController implements Serializable {
    ...
    @EJB
    private com.adsi.controller.ManufacturerFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/eng").getString("ManufacturerCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/eng").getString("ManufacturerUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/eng").getString("ManufacturerDeleted"));
        if (!JsfUtil.isValidationFailed()) {
