...
import com.adsi.controller.PurchaseOrderFacade;
...
public class PurchaseOrderController implements Serializable {
    ...
    @EJB
    private com.adsi.controller.PurchaseOrderFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/eng").getString("PurchaseOrderCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/eng").getString("PurchaseOrderUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/eng").getString("PurchaseOrderDeleted"));
        if (!JsfUtil.isValidationFailed()) {
