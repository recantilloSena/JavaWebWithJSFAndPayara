...
public class ProductCodeController implements Serializable {
    ...
    @EJB
    private com.adsi.controller.ProductCodeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/eng").getString("ProductCodeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/eng").getString("ProductCodeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/eng").getString("ProductCodeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
