...
public class ProductController implements Serializable {
    ...
    @EJB
    private com.adsi.controller.ProductFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/eng").getString("ProductCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/eng").getString("ProductUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/eng").getString("ProductDeleted"));
        if (!JsfUtil.isValidationFailed()) {
