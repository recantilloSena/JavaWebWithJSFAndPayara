...
import com.adsi.modelo.DiscountCode;
import com.adsi.view.util.JsfUtil;
import com.adsi.view.util.JsfUtil.PersistAction;
import com.adsi.controller.DiscountCodeFacade;
...
public class DiscountCodeController implements Serializable {
    ...
    @EJB
    private com.adsi.controller.DiscountCodeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/eng").getString("DiscountCodeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/eng").getString("DiscountCodeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/eng").getString("DiscountCodeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
